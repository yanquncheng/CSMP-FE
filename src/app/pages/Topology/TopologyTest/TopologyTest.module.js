(function () {
  ...
  angular.module('BlurAdmin.pages.Topology.TopologyTest', [])
      .config(routeConfig)
      .directive('goDiagramTest', directiveTestFunction);

  /** @ngInject */
  function routeConfig($stateProvider) {
    $stateProvider
        .state('dashboard.Topology.TopologyTest', {
          url: '/TopologyTest',
          templateUrl: 'app/pages/Topology/TopologyTest/TopologyTest.html',
          controller: 'TopologyTestCtrl',
          title: 'Topology Level Test',
          sidebarMeta: {
            order: 20,
          },
        });
  ...
  /** @ngInject */
  function directiveTestFunction() {
