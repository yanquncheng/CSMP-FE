...
(function () {
  ...
  angular.module('BlurAdmin.pages.CapacityManagement.capacityDistributeMap')
      .controller('capacityDistributeMapCtrl', capacityDistributeMapCtrlFunc);
	
  /** @ngInject */
  function capacityDistributeMapCtrlFunc($scope, $filter, $http, $localStorage,toastr, $uibModal, commonService,baUtil,baConfig,$timeout,$element,layoutPaths,httpService,$state) {
      ...
      $scope.initData=function(){
      	httpService.get("/capacity/distributemap", null, config, function (response){

      		$scope.CapacityDistributeMap = response;
