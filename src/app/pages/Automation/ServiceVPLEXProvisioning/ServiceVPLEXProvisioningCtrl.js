(function () {
	...
	/** @ngInject */
	function ServiceVPLEXProvisioningCtrl($scope, $filter, $http, $localStorage, httpService, $stateParams, $interval, $rootScope, MyData, toastr) {
		...
		$scope.resourceRowAdd = function () {
			...
			if (JSON.stringify(vm.resourceInfoItem) == "{}") {
				toastr.error('请选择资源池', 'Some title here', {
					"autoDismiss": true,
