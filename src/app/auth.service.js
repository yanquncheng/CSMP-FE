...
(function() {
    ...
    function AuthenticationService($http, $rootScope, $timeout, printService) {
        ...
        } else if (localStorage.getItem("menuitems") === null) { 
            var menuitem = "[]";
        ...
        service.getMenuItems = function() {
            printService.print("MenuItems is = " + localStorage.menuitems);
            var menuitems = JSON.parse(localStorage.menuitems);
        ...
        service.setMenuItems = function(menuitems) {
            printService.print("setting menuitems =  " + localStorage.menuitems); 
            localStorage.setItem("menuitems", JSON.stringify(menuitems));
            printService.print("then mentitems = " + JSON.parse(localStorage.menuitems));
        };
